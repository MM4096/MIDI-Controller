# Code adapted from https://github.com/SpotlightKid/python-rtmidi/blob/master/examples/advanced/midioutwrapper.py
...
def get_all_outputs() -> list[str]:
	midi_out = MidiOut()
	result: list[str] = midi_out.get_ports()
	del midi_out
